...
⚠️ **Пользователь предпочитает Календарь (Calendar.app) для всех событий и напоминаний.** Используй `apple-calendar`, а не этот скилл, если пользователь явно не попросил Напоминания.
